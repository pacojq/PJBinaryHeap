...
namespace PJBinaryHeap
{
	...
	///
	/// Simple BinaryHeap, implemented in C# using a List to store the
	/// elements.
	///
	/// It's a generic data structure, but any type we want to store must
	/// implement <see cref="IComparable{T}"/>, so it has te necessary
	/// methods to compute its position in the Heap.
	/// 
	/// </summary>
